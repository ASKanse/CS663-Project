function [MOVINGREG] = registerImages(IPMOVING,IPFIXED)
...
% Auto-generated by registrationEstimator app on 24-Nov-2019
%-----------------------------------------------------------
...
FIXED = rgb2gray(IPFIXED);
MOVING = rgb2gray(IPMOVING);
...
MOVINGREG.RegisteredImage(:,:,1) = imwarp(IPMOVING(:,:,1), movingRefObj, tform, 'OutputView', fixedRefObj, 'SmoothEdges', true);
MOVINGREG.RegisteredImage(:,:,2) = imwarp(IPMOVING(:,:,2), movingRefObj, tform, 'OutputView', fixedRefObj, 'SmoothEdges', true);
MOVINGREG.RegisteredImage(:,:,3) = imwarp(IPMOVING(:,:,3), movingRefObj, tform, 'OutputView', fixedRefObj, 'SmoothEdges', true);
